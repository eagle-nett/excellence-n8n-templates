# 🚀 n8n_automations: Automate everything with n8n

Welcome to **n8n_automations** – a repository of automation workflow templates for [n8n](https://n8n.partnerlinks.io/h1pwwf5m4toe), collected from the global community. Whether you are a beginner or a pro at building automation systems, here you will find countless solutions to optimize your daily work, save time and expand your creativity.

---

[![n8n](./img/n8n.png)](https://n8n.partnerlinks.io/h1pwwf5m4toe)

👉 **[Join n8n for free to start your automation journey! 💎](https://n8n.partnerlinks.io/h1pwwf5m4toe)**

---

## ⚠️ Note

The workflow templates in this repo are collected from the internet and shared for reference and use purposes.

**The author does not own, create, or take responsibility** for the content or consequences of using these templates.

All rights belong to the original author of each workflow.

---

## ☕ Support the author

If you find the project useful, please support me with a cup of coffee!

[![Buy Me A Coffee](https://cdn.buymeacoffee.com/buttons/default-orange.png)](https://coff.ee/datlee)

----

## 📚 Template Catalog & Featured Features
...
**Hãy khám phá kho mẫu trong repo này – chắc chắn có thứ bạn cần!**
